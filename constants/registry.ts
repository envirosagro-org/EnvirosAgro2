...
export const REGISTRY_NODES: RegistryGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'asset_verification', name: 'Asset Verification', icon: Scan, sections: [{id: 'scanner', label: 'Shard Scanner'}, {id: 'history', label: 'Scan History'}, {id: 'sync', label: 'Registry Sync'}] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'governance', name: 'Global Governance', icon: Landmark },
