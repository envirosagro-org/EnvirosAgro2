...
export const calibrateShardCost = (
  ...
  try {
    ...
    throw new Error("Failed to calibrate shard cost");
  }
};
...
export const calibrateMintingYield = (
  ...
  try {
    ...
    throw new Error("Failed to calibrate minting yield");
  }
};
...
export const getFullCostAudit = (
  ...
  try {
    ...
    console.error("Error getting full cost audit:", error);
    throw new Error("Failed to get full cost audit");
  }
};
