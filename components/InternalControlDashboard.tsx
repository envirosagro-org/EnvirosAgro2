  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700 max-w-[1600px] mx-auto pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        {/* Right: User Responsibilities & Path Optimization */}
        <div className="lg:col-span-4 space-y-8">
          {/* User Responsibilities Dispatcher */}
          <div className="glass-card p-10 rounded-[48px] border-indigo-500/20 bg-black/40 space-y-10 shadow-3xl relative overflow-hidden">
          ...
          <div className="glass-card p-10 rounded-[48px] border-emerald-500/20 bg-black/40 space-y-8 shadow-3xl">
            <div className="flex items-center gap-4">
