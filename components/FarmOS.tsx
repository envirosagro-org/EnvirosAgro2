...
const FarmOS: React.FC<FarmOSProps> = (props) => {
    const {
        activeTab,
        setActiveTab,
        bootStatus,
        ...
        executeToShell,
        handleShellSubmit,
      } = useFarmOS(props.user, props.onSpendEAC, props.onEarnEAC, props.onEmitSignal, props.initialCode, props.initialSection);
